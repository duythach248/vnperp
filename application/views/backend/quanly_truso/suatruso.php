    	...
    	<div class="row">
  			 <div class="col-md-7">
				  ...
				  <div class="panel-heading">
				    <h3 class="panel-title">Trụ Sở</h3>
				  </div>
				  <div class="panel-body">
				    <form class="form-horizontal" action="" method="post">
					  ...
					  <?php echo validation_errors(); ?>						
					    ...
					    <div class="col-sm-9">
							<input class="form-control" type="text" name="matruso" readonly="False" id="formGroupInputLarge1" placeholder="Mã Trụ Sở" value="<?php echo set_value('matruso', $quanly_truso['matruso']); ?>">
					    </div>
					  ...
					  <div class="form-group form-group-sm">
					    ...
					    <div class="col-sm-9">
					      <input class="form-control" type="text" name="tentruso" id="formGroupInputLarge1" placeholder="Nhập Tên Trụ Sở" value="<?php echo set_value('tentruso', $quanly_truso['tentruso']); ?>" required pattern="[a-zA-Z0-9 ÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂĐĨŨƠàáâãèéêìíòóôõùúăđĩũơƯĂẠẢẤẦẨẪẬẮẰẲẴẶẸẺẼỀỀỂưăạảấầẩẫậắằẳẵặẹẻẽềềểỄỆỈỊỌỎỐỒỔỖỘỚỜỞỠỢỤỦỨỪễệỉịọỏốồổỗộớờởỡợụủứừỬỮỰỲỴÝỶỸửữựỳỵỷỹ]{4,200}">
					    </div>
					  </div>
						<div class="form-group form-group-sm">
					    <label class="col-sm-2 control-label" for="formGroupInputSmall">Địa Chỉ*</label>
					    <div class="col-sm-9">
					      <input class="form-control" type="text" name="diachi" id="formGroupInputLarge1" placeholder="Nhập Địa Chỉ" value="<?php echo set_value('diachi', $quanly_truso['diachi']); ?>" required pattern="[a-zA-Z0-9 ÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂĐĨŨƠàáâãèéêìíòóôõùúăđĩũơƯĂẠẢẤẦẨẪẬẮẰẲẴẶẸẺẼỀỀỂưăạảấầẩẫậắằẳẵặẹẻẽềềểỄỆỈỊỌỎỐỒỔỖỘỚỜỞỠỢỤỦỨỪễệỉịọỏốồổỗộớờởỡợụủứừỬỮỰỲỴÝỶỸửữựỳỵỷỹ/]{4,200}">
					    </div>
					  </div>		  					  
