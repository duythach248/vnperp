				    ...
				    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">				   
				      <form class="navbar-form navbar-left">
						<div class="btn-group" role="group" aria-label="...">
						  <button type="button" class="btn btn-default" <?php echo (isset($active) && $active == 'quanly-truso-themmoitruso')?' class="active"':''?>><a href="index.php/quanly_truso/themmoitruso"><span class="glyphicon glyphicon glyphicon-plus" aria-hidden="true"></span>Thêm Mới</a></button>
						</div> 				
				      </form>
			 ...
			 <form action="" method="post">
  			 <div class="panel panel-primary">
				  <div class="panel-heading">
					<h3 class="panel-title">Bảng Trụ Sở</h3>
				  </div>
