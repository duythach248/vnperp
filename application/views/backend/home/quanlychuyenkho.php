				  ...
				  <div class="container-fluid">
				    ...
				    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">				   
					  ...
					  <div class="btn-group" role="group" aria-label="...">
						  <button type="button" class="btn btn-default" <?php echo (isset($active) && $active == 'taomoiphieuchuyenkho')?' class="active"':''?>><a href="index.php/quan-ly-kho/quan-ly-chuyen-kho/tao-phieu-chuyen-kho"><span class="glyphicon glyphicon glyphicon-plus" aria-hidden="true"></span>Thêm Mới</a></button>
					  </div>
  		...
  		<div class="row">
  			 ...
  			 <div class="panel panel-primary">
				  <div class="panel-heading">
					<h3 class="panel-title">Bảng Chuyển Kho</h3>
				  </div>
