    	...
    	<div class="row">
			  ...
			  <div class="panel panel-primary">
				  <div class="panel-heading">
				    <h3 class="panel-title">Tạo Phiếu Nhập Kho</h3>
				    <div id="setbutton">
				    	<div class="row">
				  ...
				  <label class="control-label" style="margin-top: 10px;">Ngày Nhập</label>	
				   ...
				   <div class="col-md-7">
					    ...
					    <label class="col-sm-4 control-label" for="formGroupInputSmall" style="margin-top: 20px">Loại Nhập*</label><br>
					    <div class="col-sm-7">
				  ...
				  <div class="col-md-12">
				  	<div class="panel-body">
                            <ul class="nav nav-tabs">
                                ...
                                <li class=""><a href="#profile" data-toggle="tab">Thông Tin Nhập</a>
                                </li>     
