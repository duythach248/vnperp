    	...
    	<div class="row">
			  ...
			  <div class="panel panel-primary">
				  <div class="panel-heading">
				    <h3 class="panel-title">Tạo Phiếu Chuyển Kho</h3>
				    <div id="setbutton">
				    	<div class="row">
				  ...
				  <label class="control-label" style="margin-top: 10px;">Ngày Chuyển</label>	
				   ...
				   <div class="col-md-7">
					    ...
					    <label class="col-sm-4 control-label" for="formGroupInputSmall" style="margin-top: 20px">Kho Xuất*</label><br>
					    <div class="col-sm-7">
					      <select class="form-control input-sm">...</select>
					    </div>
					  </div>
					  <div class="form-group form-group-sm">
					    <label class="col-sm-4 control-label" for="formGroupInputSmall" style="margin-top:10px ">Kho Nhập*</label>
					    <div class="col-sm-7"><br>
					      <select class="form-control input-sm" style="margin-top: -10px">...</select>
					    </div>
					  </div>
					  <div class="form-group form-group-sm">
					    <label class="col-sm-4 control-label" for="formGroupInputSmall" style="margin-top: 10px">Loại Chuyển</label>
					    <div class="col-sm-7">
					      <select class="form-control input-sm" style="margin-top: 10px">...</select>
					    </div>
					  </div>
				  ...
				  <div class="col-md-12">
				  	<div class="panel-body">
                            <ul class="nav nav-tabs">
                                ...
                                <li class=""><a href="#profile" data-toggle="tab">Thông Tin Chuyển</a>
                                </li>     
