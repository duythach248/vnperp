			  ...
			  <div class="panel panel-primary">
				  ...
				  <label class="control-label" style="margin-top: 10px;">Ngày Kết Thúc</label>	
				   ...
				   <div class="col-md-7">
					  ...
					  <div class="form-group form-group-sm">
					    <label class="col-sm-4 control-label" for="formGroupInputSmall" style="margin-top:10px ">Tên Dự Án*</label>
					  ...
					  <div class="form-group form-group-sm">
					    ...
					    <div class="col-sm-7"><br>
						  <input class="form-control" type="text" placeholder="Nhập Tên Khách Hàng" style="margin-top: -10px">
					    </div>
					  </div>
					  <div class="form-group form-group-sm">
