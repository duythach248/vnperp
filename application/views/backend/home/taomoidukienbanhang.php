    	...
    	<div class="row">
			  ...
			  <div class="panel panel-primary">
				  <div class="panel-heading">
				    <h3 class="panel-title">Tạo Phiếu Dự Kiến Bán Hàng</h3>
				    <div id="setbutton">
				    	<div class="row">
				  ...
				  <label class="control-label" style="margin-top: 10px;">Ngày Kết Thúc</label>	
				   ...
				   <div class="col-md-7">
					    ...
					    <label class="col-sm-4 control-label" for="formGroupInputSmall" style="margin-top: 20px">Mã Phiếu</label><br>
					    <div class="col-sm-7">
					      <input class="form-control" id="disabledInput" type="text" placeholder="" disabled>
					    </div>
					  </div>
					  <div class="form-group form-group-sm">
					    <label class="col-sm-4 control-label" for="formGroupInputSmall" style="margin-top:10px ">Tên Phiếu*</label>
					    <div class="col-sm-7"><br>
						  <input class="form-control" type="text" placeholder="Nhập Tên Phiếu" style="margin-top: -10px">
					    </div>
					  </div>
					  <div class="form-group form-group-sm">
					    <label class="col-sm-4 control-label" for="formGroupInputSmall" style="margin-top: 10px">Ghi Chú</label>
					    <div class="col-sm-7">
					      <input class="form-control" placeholder="Nhập Ghi Chú" style="margin-top: 10px; Height: 50px"></input>
					    </div>
					  </div>
				  	</div>		  
				  <div class="col-md-12">
