				    ...
				    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">				   
				      <form class="navbar-form navbar-left">
						<div class="btn-group" role="group" aria-label="...">
						  <button type="button" class="btn btn-default" <?php echo (isset($active) && $active == 'quanly-danhmucsp-themmoidanhmucsp')?' class="active"':''?>><a href="index.php/quanly_danhmucsp/themmoidanhmucsp"><span class="glyphicon glyphicon glyphicon-plus" aria-hidden="true"></span> Thêm Mới</a></button>
						</div> 					     		       
				      </form>
			 ...
			 <form action="" method="post">
  			 <div class="panel panel-primary">
				  ...
				  <thead>
					 ...
					 <tbody> 
				     <?php if(isset($list_quanly_danhmucsp) && count($list_quanly_danhmucsp)){foreach($list_quanly_danhmucsp as $key => $val){?>
						<tr>	
							<th><input type="checkbox" name="checkbox[]" value="<?php echo $val['stt'];?>" /></th>
							<th><input type="checkbox" name="checkbox[]" value="<?php echo $val['stt'];?>" /></th>
                            <th><a href="index.php/quanly_danhmucsp/updatedmsp/<?php echo $val['stt'];?>"><?php echo htmlspecialchars($val['madanhmuc']);?></th>						
                            <th><?php echo htmlspecialchars($val['tendanhmuc']);?></th>
                        </tr>
					 <?php	}} //else { 		
						//}
					 ?>  
