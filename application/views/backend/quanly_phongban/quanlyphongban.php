				    ...
				    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">				   
				      <form class="navbar-form navbar-left">
						<div class="btn-group" role="group" aria-label="...">
						  <button type="button" class="btn btn-default" <?php echo (isset($active) && $active == 'quanly-phongban-themmoiphongban')?' class="active"':''?>><a href="index.php/quanly_phongban/themmoiphongban"><span class="glyphicon glyphicon glyphicon-plus" aria-hidden="true"></span>Thêm Mới</a></button>
						</div> 	
				      </form>
			 ...
			 <form action="" method="post">
  			 <div class="panel panel-primary">
				  <div class="panel-heading">
					<h3 class="panel-title">Bảng Phòng Ban</h3>
				  </div>
				  ...
				  <thead>
				    <tr>	
                     ...
                     <tbody>
						<?php if(isset($list_quanly_phongban) && count($list_quanly_phongban)){foreach($list_quanly_phongban as $key => $val){?>
						<tr>	
							<th><input type="checkbox" name="checkbox[]" value="<?php echo $val['id'];?>" /></th>
							<th><input type="checkbox" name="checkbox[]" value="<?php echo $val['id'];?>" /></th>
                            <th><a href="index.php/quanly_phongban/capnhatphongban/<?php echo $val['id'];?>"><?php echo htmlspecialchars($val['maphongban']);?></th>						
                            <th><?php echo htmlspecialchars($val['tenphongban']);?></th>
							<th><?php echo htmlspecialchars($val['truso']);?></th>
                        </tr>
					 <?php	}} //else { 		
						//}
					 ?> 
